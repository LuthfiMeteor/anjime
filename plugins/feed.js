    ...
    switch (type) {
      ...
      case 'centaur':
        ...
        case 'griffin':
            ...
            let __waktufin = (new Date - global.db.data.users[m.sender].griffinastclaim)
        ...
        case 'kucing':
            ...
            break
        default:
            return conn.reply(m.chat, `${usedPrefix + command} [kucing | rubah | kuda | naga | centaur | kyubi | griffin | phonix | serigala]\nContoh penggunaan: *${usedPrefix + command} kucing*`, m)
    }
}
